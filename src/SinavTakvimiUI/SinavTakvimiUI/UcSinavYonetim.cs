...
{
    public partial class UcSinavYonetim : UserControl
    {
        public UcSinavYonetim()
        {
            InitializeComponent();
        ...
        private void btnGozetmenAta_Click(object sender, EventArgs e)
        {
            ...
            int atamaID = Convert.ToInt32(dgvSalonlar.CurrentRow.Cells["AtamaID"].Value);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                dashboard.LoadContent(new UcTakvim());
            }
        }
        ...
        private void btnRaporlar_Click(object sender, EventArgs e)
        {
            if (this.ParentForm is FrmDashboard dashboard)
            {
                dashboard.LoadContent(new UcRaporlar());
            }
        }
    }
}
