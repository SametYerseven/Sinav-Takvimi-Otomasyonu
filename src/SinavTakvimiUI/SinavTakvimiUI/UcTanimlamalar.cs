...
{
    public partial class UcTanimlamalar : UserControl
    {
        ...
        {
            ThemeHelper.ApplyFormTheme(this.FindForm() ?? new Form());
        ...
        private void ApplyThemeToControls(Control.ControlCollection controls)
        {
            ...
            foreach (Control control in controls)
            {
                ...
                else if (control is Label label && (label.Name == "lblFormBaslik" || label.Text == "Tanımlamalar Modülü"))
                {
        ...
        private void UcTanimlamalar_Load(object sender, EventArgs e)
        {
            TumListeleriYenile();
        }
